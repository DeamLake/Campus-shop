            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix dropdown active">
                ...
                <ul class="dropdown-menu" style="display: block;">
                  ...
                  <li class="active"><a href=""><i class="fa fa-angle-right"></i> 未收货(<?php echo $getin_count ?>)</a></li>
            ...
            <div class="content-page">
              <div class="goods-data clearfix">
                ...
                <table summary="Shopping cart">
                  ...
                  <?php if($orders){foreach ($orders as $value): if($value['order_state']=='已发货'){ ?>
                  <tr>
                    ...
                    <td>
                      <?php if($value['delivery_id']=='无'){ ?>
                      <a class="btn btn-default"><?php echo '等待配送' ?></a>
                      <?php }else{ ?>
                      <a class="btn btn-default"><?php echo '配送中' ?></a>
                      <?php } ?>
                    </td>
                  </tr>
                  <?php } endforeach;} ?>
