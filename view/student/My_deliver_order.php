            ...
            <ul class="list-group margin-bottom-25 sidebar-menu">
              ...
              <li class="list-group-item clearfix dropdown">
                ...
                <ul class="dropdown-menu" style="display: block;">
                  ...
                  <li class="active"><a href=""><i class="fa fa-angle-right"></i> 我的订单</a></li>
              ...
              <div class="goods-data clearfix">
                ...
                <table summary="Shopping cart">
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-default" href="index.php?r=student/Have_finished_Order&order_id=<?php echo $value['order_id'];?>">已完成配送</a>
                    </td>
                  </tr>
                  <?php endforeach;} ?>
                </tbody></table>
